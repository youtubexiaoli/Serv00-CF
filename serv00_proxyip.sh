...
menu() {
   clear
   echo "========================================================="
   purple "修改自Serv00|ct8老王和yonggekkk甬哥的sing-box安装脚本"
   purple "转载请著名出自老王和yonggekkk，请勿滥用"
   yellow "Xiaoli的Github项目  ：github.com/youtubexiaoli"
   yellow "Xiaoli的博客 ：www.5881314.xyz"
   yellow "Xioali的YouTube频道 ：www.youtube.com/@gBxiaoli"
   yellow "一键三协议共存：vless-reality、Vmess-ws(Argo)、hysteria2"
   yellow "当前脚本版本：V24.12.18 "
   echo "========================================================="
   green  "1. 安装sing-box"
   echo   "---------------------------------------------------------"
   red    "2. 卸载sing-box"
